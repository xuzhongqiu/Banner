...
public class FastBlur
{
    ...
    {
        if (bitmap != null && bitmap.getWidth() / scale >= 1.0f &&
                bitmap.getHeight() / scale >= 1.0f)
        {
    ...
    private static int setYp(int w, int hm, int i, int yp)
    {
        if (i < hm)
        {
            yp += w;
    ...
    private static int[] setDV(int div)
    {
        int i;
        int divsum = (div + 1) >> 1;
        divsum *= divsum;
    ...
    public static Bitmap getBitmap(Bitmap sentBitmap)
    {
